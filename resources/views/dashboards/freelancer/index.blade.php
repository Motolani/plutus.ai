                ...
                <div class="card user-profile-card">
                    <div class="card-header text-center">
                        ...
                        <div class="user-profile-identity">
                            ...
                            <p class="user-profile-role">Freelancer</p>
                        </div>
                    </div>
                    <div class="card-body ">
                    ...
                    <div class="profile-nav">
                        ...
                        <div class="container user-nav-content">
                            ...
                            <div id="user_info" data-tab-content class="active">
                                <form action="{{route('update.freelancerprofile')}}" method="POST" class="g-3">
                                    @csrf 
                            ...
                            {{-- BILLINGS --}} <div id="billing" data-tab-content>
                                <div class="row pt-4 ml-3">
                                    <div class="col-sm-6 img-container">
                                        ...
                                        <div class="plan_management pl-3 text-white">
                                            ...
                                            <h3 class="mt-0 mb-1">$19.99<span>/ mo</span> </h3>
                                            <h4>Freelancer</h4>
                                        </div>
                                        <div class="change_plan">
                                            <form action="{{ route('plans.index') }}" method="POST">
                                                @csrf
                                                @method('put')
                                                <button type="submit" class="btn btn-light btn-sm text-info">Manage Plan</button>
                                            </form>
                                        </div>
                            ...
                            <div id="settings" data-tab-content>
                                {{-- Update Password --}}
                                <form action="{{ route('update.freelancerpassword') }}" method="POST" class="g-3">
                                    @csrf 
                                    @if(session('success'))
                                        <div class="alert alert-success mt-4" role="alert">
                                            {{session('success')}}
                                ...
                                {{-- Upload Avatar --}}
                                <form action="{{ route('upload.freelanceravatar') }}" method="POST" class="g-3" enctype="multipart/form-data">
                                    @csrf
