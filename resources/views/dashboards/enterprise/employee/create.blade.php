                    ...
                    <div class="col-md-12 col-sm-6">
                        <div class="row">
                            <div class="col-md-6 offset-md-3 col-8 offset-2 pt-5">
                                <h3>Register an Employee</h3><br>
                                <form action="{{ route('enterprise.employee.store') }}" method="POST" class="register-form" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="name-register-input">
                                            <input id="company_name" type="text" class="form-control @error('company_name') is-invalid @enderror" name="company_name" value="{{ old('company_name') }}" required autocomplete="company_name" placeholder="Enter Your company Name" autofocus>
                                            @error('company_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
